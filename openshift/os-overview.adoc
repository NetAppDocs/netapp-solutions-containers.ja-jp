...
. Red Hat が提供するlink:https://docs.openshift.com/container-platform/4.7/installing/index.html["インストール手順"^]に従って、選択した環境にデプロイしてください。
...
* link:os-on-bm.html["ベアメタル上の OpenShift"]
* link:os-on-openstack.html["Red Hat OpenStack プラットフォーム上の OpenShift"]
* link:os-on-rhv.html["Red Hat Virtualization 上の OpenShift"]
* link:os-on-vmw.html["VMware vSphere 上の OpenShift"]
