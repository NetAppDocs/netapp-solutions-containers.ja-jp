...
インストールと設定の詳細については、link:https://docs.netapp.com/us-en/trident/index.html["Trident製品ドキュメント"^]を参照してください。
...
. インストールアーカイブを管理用ワークステーションにダウンロードし、内容を解凍してください。現在のバージョンの Trident はlink:https://github.com/NetApp/trident/releases?q=25.&expanded=true["Tridentリリースページ（GitHub）"^]からダウンロードできます。
