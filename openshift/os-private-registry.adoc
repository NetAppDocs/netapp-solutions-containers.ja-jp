...
[role="lead"]
Red Hat OpenShift のほとんどのデプロイメントでは、link:https://quay.io["Quay.io"^] や link:https://hub.docker.com["Dockerハブ"^] などのパブリックレジストリを使用することで、ほとんどのお客様のニーズを満たすことができます。ただし、お客様が独自のプライベートイメージやカスタマイズされたイメージをホストしたい場合もあります。
