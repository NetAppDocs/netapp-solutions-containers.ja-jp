...
詳細については、link:https://www.openshift.com["Red Hat OpenShiftのウェブサイト"^]をご覧ください。
...
詳細については、link:https://www.netapp.com["NetApp Webサイト"^]をご覧ください。
...
NetApp Tridentは、{k8s_distribution_name}などのコンテナやKubernetesディストリビューション向けのオープンソースで完全にサポートされているストレージオーケストレーターです。詳細については、link:https://docs.netapp.com/us-en/trident/index.html["Tridentドキュメント"^]を参照してください。
...
どのバージョンの Trident がどの Kubernetes ディストリビューションでテストされたかのサポートマトリックスは、link:https://docs.netapp.com/us-en/trident/trident-get-started/requirements.html#supported-frontends-orchestrators["サポートされているフロントエンド（オーケストレータ）"^] に記載されています。
